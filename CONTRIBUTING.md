...
- **Translations** — improve the Greek or English strings (all labels live in the `STATIC` / `PH` objects inside `index.html`).
...
2. Keep it **one file, zero dependencies, offline** — that's the contract.
